...
{
    painter.fillPath(this.shape, new QBrush(new QColor(Qt.blue)));
}
...
Window.prototype.setupShapes = function()
{
    ...
    var fontBoundingRect = new QFontMetrics(this.font).boundingRect(tr("Qt"));
    text.addText(new QPointF(fontBoundingRect.center()), this.font, tr("Qt"));
