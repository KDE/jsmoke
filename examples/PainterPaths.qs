...
RenderArea.prototype.paintEvent = function()
{
    ...
    painter.setPen(new QPen(new QBrush(this.penColor), this.penWidth, Qt.SolidLine, Qt.RoundCap,
                        Qt.RoundJoin));
...
function Window(parent)
{
    ...
    this.fillRuleComboBox.addItem(tr("Odd Even"), new QVariant(Qt.OddEvenFill));
    this.fillRuleComboBox.addItem(tr("Winding"), new QVariant(Qt.WindingFill));
...
{
    var rule = this.currentItemData(this.fillRuleComboBox).valueOf();
...
{
    var color1 = this.currentItemData(this.fillColor1ComboBox).valueOf();
    var color2 = this.currentItemData(this.fillColor2ComboBox).valueOf();
...
{
    var color = this.currentItemData(this.penColorComboBox).valueOf();
...
Window.prototype.populateWithColors = function(comboBox)
{
    ...
    for (var i = 0; i < colorNames.length; ++i) {
        ...
        comboBox.addItem(name, QVariant.fromValue(new QColor(name)));
    }
}
