...
Window.prototype.alignmentChanged = function(index) {
    switch (index) {
    case 0:
        this.alignmentLineEdit.alignment = Qt.AlignLeft;
        break;
    case 1:
        this.alignmentLineEdit.alignment = Qt.AlignCenter;
        break;
    case 2:
    	this.alignmentLineEdit.alignment = Qt.AlignRight;
    }
};
