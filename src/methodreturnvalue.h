...
#ifndef JSMOKE_METHOD_RETURN_VALUE_H
#define JSMOKE_METHOD_RETURN_VALUE_H
...
namespace JSmoke {
    ...
    class JSMOKE_EXPORT MethodReturnValue : public Marshall {
...
#endif // JSMOKE_METHOD_RETURN_VALUE_H
